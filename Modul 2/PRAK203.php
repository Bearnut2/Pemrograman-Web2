...
<body>
    <form action="" method="post">
        Nilai <input type="number" name="suhu"></input></br> Dari : </br>
	    ...
	    <input type="radio" name="suhuawal" value="Kelvin">Kelvin<br> Ke : </br>
...
if (isset($_POST["submit"])) {
    ...
    if ($suhuawal == "Celcius") {
        ...
        } elseif ($suhuawal == "Fahrenheit") { if ($suhuakhir == "Celcius") {
        ...
        } elseif ($suhuawal == "Reamur") { if ($suhuakhir == "Celcius") {
        ...
        } elseif ($suhuawal == "Kelvin") { if ($suhuakhir == "Celcius") {
